...
class Ui_WalletsWindow(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(1450, 930)
        Dialog.setMinimumSize(QSize(1450, 930))
        Dialog.setMaximumSize(QSize(1450, 930))
        icon = QIcon()
        icon.addFile(u":/icon/icons/icon.ico", QSize(), QIcon.Normal, QIcon.On)
...
"}")
        ...
        self.label.setGeometry(QRect(540, 40, 351, 140))
        ...
        self.new_wallet_button.setGeometry(QRect(580, 320, 281, 41))
        font = QFont()
...
"}")
        ...
        self.listWidget.setGeometry(QRect(370, 500, 721, 371))
        font1 = QFont()
...
"")
        ...
        self.private_key_button.setGeometry(QRect(580, 440, 281, 41))
...
"}")
        ...
        self.mnemonic_button.setGeometry(QRect(540, 380, 341, 41))
...
"}")
        ...
        self.headerContainer.setGeometry(QRect(0, 0, 1451, 41))
